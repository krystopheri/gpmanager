		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
				 ...
				 You are about to Edit a result entry   
			...
			<div class="panel-body">
				...
				echo $message;
				echo form_open('admin/edit_session/edit', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"> Edit Results </button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>  
