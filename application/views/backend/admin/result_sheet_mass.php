                            ...
                            <table class="table table-bordered">
                               ...
                               foreach($gps as $gp){ ?>
                                <tr>
                                    ...
                                    <td> ESUT<?php echo $gp['details']['reg_no'];?> </td>
                                    ...
                                    <td> <?php echo $gp['gp'][0]['tc'];?> </td>
                                     <td> <?php echo $gp['gp'][0]['tp'];?> </td>
   ...
   <?php foreach($gps as $gp){ ?>
	...
	<?php for ($k = 0; $k < count($gp['gp']); $k++){ ?>
                                <div class='row'> 
                                    <center>   <h3 class='well'> <?php echo $gp['gp'][$k][1][0]['session'];?>  SESSION (<?php echo $gp['gp'][$k]['session_gp'];?>)</h3> </center>
