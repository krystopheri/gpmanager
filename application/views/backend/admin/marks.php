                ...
                <table class="table table-bordered" >
                    <thead>
                        <tr>
                            ...
                            <td><?php echo get_phrase('continous_assesment');?>(out of 10)</td>
                            <td><?php echo get_phrase('project');?>(out of 20)</td>
                    ...
                    <tbody>
						...
						foreach($students as $row):
							...
							<tr>
                                ...
                                <td>
                                     <input type="number" value="<?php echo $row2['continous_assesment'];?>" name="continous_assesment" class="form-control"  />
                                                
                                </td>
                                <td>
                                     <input type="number" value="<?php echo $row2['project'];?>" name="project" class="form-control"  />
